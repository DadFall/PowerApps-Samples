...
import { FluentThemingAPIComponent, IFluentThemingAPIComponentProps } from "./components/FluentThemingAPIComponent";

export class FluentThemingAPIControl implements ComponentFramework.ReactControl<IInputs, IOutputs> {
	/**
	 * Empty constructor.
	 */
	constructor() {
	 ...
	 * @param _container If a control is marked control-type='standard', it will receive an empty div element within which it can render its content.
	 */
	public init(
	...
	public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
		return React.createElement(FluentThemingAPIComponent, {
			context: context,
		} as IFluentThemingAPIComponentProps);
	}
