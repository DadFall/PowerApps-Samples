namespace PowerApps.Samples.Messages
{
    ...
    public sealed class DownloadFileChunkRequest : HttpRequestMessage
    {
        ...
        /// </summary>
        /// <param name="entityReference">一个reference to the record that has the file column to download.</param>
        /// <param name="fileColumnLogicalName">logical 名称 of the file column.</param>
        /// <param name="offSet">size of the offset in bytes.</param>
        /// <param name="chunkSize">number of bytes being sent.</param>
