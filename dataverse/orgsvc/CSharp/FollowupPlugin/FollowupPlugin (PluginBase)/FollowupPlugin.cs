...
{
    /// <summary>
        /// plug-in creates a task activity after a new account is created. The activity reminds the user to
    ...
    public class FollowupPlugin : PluginBase  // Inherits from PluginBase
    {
        ...
        protected override void ExecuteDataversePlugin(ILocalPluginContext localPluginContext)
        {
                ...
                context.InputParameters["Target"] is Entity)
            {
                ...
                // 验证that the target entity represents an account.
                // 如果not, this plug-in was not registered correctly.
                if (entity.LogicalName != "account")
                    return;

                try
                {
                    // 创建a task activity to follow up with the account customer in 7 days. 
                    ...
                    // 创建the task in Microsoft Dynamics CRM.
