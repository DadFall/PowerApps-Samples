...
namespace PowerApps.Samples
{
    ...
    public partial class SampleProgram
    {
        ...
        /// 创建a publisher
        /// 创建a new solution, "Primary"
        /// 创建a Global Option Set in solution "Primary"
        /// Export the "Primary" solution, setting it to Protected
        /// 删除the option set and solution
        /// Import the "Primary" solution, creating a managed solution in CRM.
        /// 创建a new solution, "Secondary"
        /// 创建an attribute in "Secondary" that references the Global Option Set
        /// </summary>
        public static void CreateRequiredRecords(CrmServiceClient service)
        {
            ...
            // 删除the option set previous created, so it can be imported under the
            // managed solution.
            ...
            // 删除the previous primary solution, so it can be imported as managed.
            ...
            // 检索the solution from CRM in order to get the new id.
            ...
            // 创建a Picklist attribute in the secondary solution linked to the option set in the
        ...
        /// <param name="dependency">一个Dependency returned from the RetrieveDependentComponents message</param>
        /// </summary> 
        public static void DependencyReport(CrmServiceClient service, Dependency dependency)
        {
            ...
            //ComponentType global Option Set contains options for each possible component.
            ...
            //name or display name of the compoent is retrieved in different ways depending on the component type
            ...
            // 检索the friendly name for the dependent solution.
            ...
            // 检索the friendly name for the required solution.
        ...
        // name or display name of the component depends on the type of component.
        public static String getComponentName(CrmServiceClient service, int ComponentType, Guid ComponentId)
        {
            ...
            {
                // 一个separate method is required for each type of component
        ...
        // 检索the display name and parent entity information about an attribute solution component.
