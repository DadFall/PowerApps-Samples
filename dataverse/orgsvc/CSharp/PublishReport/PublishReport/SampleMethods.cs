...
namespace PowerApps.Samples
{
    ...
    {
        static Guid _reportId;
        static Guid _reportCategoryId;
        static Guid _reportVisibilityId1;
        static Guid _reportVisibilityId2;
        static Guid _reportVisibilityId3;
        static Guid _reportEntityId;
