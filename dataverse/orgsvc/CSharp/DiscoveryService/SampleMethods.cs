...
namespace PowerApps.Samples
{
    ...
    {
        /// <summary>
        /// 获取 organization data for the specified user.
        /// </summary>
        /// <param name="username">user's user名称</param>
        /// <param name="password">user's password</param>
        /// <param name="cloud">Cloud enum 值 that corresponds to the 数据 center if known. Otherwise Cloud.Unknown</param>
        ...
        {
            //如果Cloud.Unknown is used, choose Commercial
            if (cloud == Cloud.Unknown)
            {
                cloud = Cloud.Commercial;
            }
            // 获取data from Organization
            return GetOrganizationsForCloud(userName, password, cloud);
        }

        /// <summary>
        /// 获取organization data for a specific known region only
        /// </summary>
        ...
        public static List<OrganizationDetail> GetOrganizationsForCloud(string userName, string password, Cloud cloud)
        {
            ...
            // 调用to get organizations from global discovery
