...
namespace PowerPlatform.Dataverse.CodeSamples.types
{
    ...
    public sealed class SearchQueryResults
    {
        ...
        /// <summary>
        /// 如果facets were requested in the query, a dictionary of facet values.
        /// </summary>
        ...
        /// <summary>
        /// 如果`"Count": true` is included in the body of the request, the count of all documents that match the search, ignoring top and skip.
        /// </summary>
